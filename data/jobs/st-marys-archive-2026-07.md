...
# St Mary's Refurbishment, Merthyr Tydfil - E T & S Construction - archived detail (moved 2026-08-03)

Moved out of `data/jobs/st-marys.md` to bring it inside the 300-line seed contract. Nothing was edited or dropped - this is the file's own text, verbatim. The live file keeps the position, the number and what is outstanding; this keeps the working detail behind them.
