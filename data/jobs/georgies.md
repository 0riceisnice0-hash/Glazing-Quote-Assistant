...
104 lines of working detail moved to `data/jobs/georgies-archive-2026-07.md` on 2026-08-03 to bring this file inside the seed contract. Nothing was dropped. Go there when this file leaves a specific gap - and if it does, fix this file so the next chat is not missing it too.
