...
# Gordon Court, Stonegrove, Edgware HA8 7TQ — Chigwell Group - archived history (moved 2026-08-03)

Moved out of `data/jobs/gordon-court.md` to bring it inside the 300-line seed contract. Nothing was edited or dropped; this is the file's own history, verbatim, from the point where it stopped being position and started being a log. Read it when the live file leaves a specific gap.
