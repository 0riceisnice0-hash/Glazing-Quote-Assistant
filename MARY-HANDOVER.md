...
Last updated: 2026-07-17 (end of the session that built the rate register, house formats and priced Brocks Hill, Crownhill, Greenfields, Filwood, Lyttleton).
...
6. **Outputs per job (three sets)**:
   ...
   - House proposal PDF: `outputs\<Job> - Fenster Glazing Proposal (house format).pdf` (photos = placeholders unless supplied).
...
- **UNRESOLVED DISCREPANCY (asked Adam 2026-07-17):** template adders < engine markups (Lyttleton: GBP41,138 house vs GBP43,451 internal). Until Adam rules: house docs use template maths, internal reviews use engine.
